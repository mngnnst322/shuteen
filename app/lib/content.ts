...
const mn = {
  company: {
    ...
    tagline: "Чанартай вакум цонх, хаалганы шийдэл",
    category: "Вакум цонхны үйлдвэрлэл · Улаанбаатар, Монгол",
    intro:
      "Индэрт Шүтээн ХХК нь Монгол улсад тэргүүлэх чанарын вакум цонх, хаалга үйлдвэрлэгч компани юм. Бид PVC профиль ашиглан олон давхар шилтэй, дулааны алдагдлыг бууруулсан цонхны шийдлийг танд санал болгодог.",
  ...
  hero: [
    {
      heading: "Индэрт Шүтээн ХХК нь чанарын вакум цонх, хаалганы үйлдвэр",
      subtitle:
        "Индэрт Шүтээн ХХК нь Монгол улсад тэргүүлэх чанарын вакум цонх, хаалга үйлдвэрлэгч компани юм. Бид PVC профиль ашиглан олон давхар шилтэй, дулааны алдагдлыг бууруулсан цонхны шийдлийг танд санал болгодог.",
  ...
  services: [
    { title: "Вакум цонх үйлдвэрлэл", description: "Дулаан алдагдлыг бууруулсан, олон давхар шилтэй вакум цонхыг хэмжээгээр захиалгаар хийнэ.", icon: "🪟" },
  ...
  news: [
    { slug: "winter-discount", title: "Өвлийн хямдралын урамшуулал эхэллээ", date: "2026-06-01", excerpt: "Энэ улирлын турш бүх төрлийн вакум цонхонд онцгой хямдрал зарлаж байна. Дэлгэрэнгүй мэдээллийг доороос үзнэ үү." },
  ...
  about: {
    subtitle: "Вакум цонхны үйлдвэрлэл · Улаанбаатар, Монгол",
    lead: {
      before: " нь Монгол улсад тэргүүлэх чанарын вакум цонх, хаалга үйлдвэрлэгч компани юм. Бид ",
      pvc: "PVC профиль",
    ...
    quickFacts: [
      ...
      { icon: "🏷️", label: "Мэргэшлийн чиглэл", value: "PVC вакум цонх, хаалга" },
  ...
  calculator: {
    ...
    chooseConfig: "Онгойлтын тодорхойлолт тодорхойлно уу",
    config: "Тохиргоо",
    ...
    designs: { one: "Нэг хуваалт", two: "Хоёр хуваалт", three: "Гурав хуваалт", door: "Тагттай хуваалт" } as Record<string, string>,
    colors: { white: "Цагаан", gray: "Саарал", brown: "Хүрэн", oak: "Царс мод" } as Record<string, string>,
    openings: {
      fixed: "Онгойлтгүй",
      turnR: "Баруун онгойлт",
      turnL: "Зүүн онгойлт",
      tilt: "Дээшээ онгойлт",
      tiltTurnR: "Дээшээ, баруун онгойлт",
      tiltTurnL: "Дээшээ, зүүн онгойлт",
...
const en: typeof mn = {
  ...
  calculator: {
    ...
    openings: {
      ...
      turnL: "Left opening",
      tilt: "Tilt opening",
      tiltTurnR: "Tilt + right opening",
      tiltTurnL: "Tilt + left opening",
    },
  },
